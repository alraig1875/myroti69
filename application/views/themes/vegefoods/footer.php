           ...
           <div class="ftco-footer-widget mb-4">
            ...
            <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  <li><a href="<?php echo site_url('shop/cart'); ?>" class="py-2 d-block">Keranjang Pesanan</a></li>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="icon-heart text-danger" aria-hidden="true"></i> The AI Team
...
<script>
  ...
  window.watsonAssistantChatOptions = {
    integrationID: "18ef5b8e-922e-4ffb-9530-fded6ecca3cf", // The ID of this integration.
    region: "us-south", // The region your integration is hosted in.
    serviceInstanceID: "d19a39b8-1a37-4795-8271-bec3eb586896", // The ID of your service instance.
